...
public resetfunction()
{
  ...
  constructor(private pageService: PageService,private commonService:CommonService, private departmentServiceObj: DepartmentService,
  ...
  ngOnInit() {
    this.commonService.setTitle('IMS-Catalogue-Department');
    this.getDepartmentList(this.data);
  }
  ...
  public getDepartmentList(data) {
    ...
    this.departmentServiceObj.getDepartmentList(data).subscribe(res => {
  ...
  createDepartment(depName) {
    ...
    if (depName === "") {
      ...
      this.departmentServiceObj.createDepartment(this.dataForDeptCreation).subscribe(response => {
  ...
  editDepartment(depName) {
    ...
    if (depName === "") {
      ...
      console.log("data to update:-> " + this.dataForDeptCreation.name, this.dataForDeptCreation.id, this.dataForDeptCreation.status);

      this.departmentServiceObj.updateDepartment(this.dataForDeptCreation).subscribe(response => {
  ...
  changeStatus(id) {
    ...
    swal({
      ...
      if (result.value) {
        ...
        this.departmentServiceObj.changeStatus(objToDel).subscribe(res => {
  ...
  importAsXLSX() {
    ...
    if (this.fileToUpload) {
      this.importExcelService.uploadBrand(this.fileToUpload, 1, 'api/Department/Import').subscribe(res => {
