...
export class CountryComponent implements OnInit {
 ...
 public resetfunction()
 {
  ...
  constructor(private importExcelService: ImportService,
    ...
    private pageService: PageService, private countryServiceObj: CountryService,
  ...
  ngOnInit() {
    this.commonService.setTitle('IMS-Location-Country');
    this.getCountryList(this.data);
  ...
  public getCountryList(data) {
    ...
    this.spinner.show();
    this.countryServiceObj.getCountryListt(data).subscribe(res => {
      this.spinner.hide();
      console.log('countryList data received:-> ');
  ...
  createCountry(countryCode, countryName) {
    ...
    if (msg != "") {
      ...
      this.spinner.show();
      this.countryServiceObj.createCountry(this.dataForCountryCreation).subscribe(response => {
  ...
  editCountry() {
    ...
    if (msg != "") {
      ...
      this.spinner.show();
      this.countryServiceObj.updateCountry(this.dataForCountryCreation).subscribe(response => {
  ...
  importAsXLSX() {
    ...
    if (this.fileToUpload) {
      this.spinner.show();
      this.importExcelService.uploadBrand(this.fileToUpload, 1, 'api/Country/Import').subscribe(res => {
  ...
  changeStatus(id) {
    ...
    swal({
      ...
      if (result.value) {
        ...
        this.spinner.show();
        this.countryServiceObj.changeStatus(objToDel).subscribe(res => {
          this.spinner.hide();
