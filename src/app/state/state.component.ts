...
export class StateComponent implements OnInit {
 ...
 { console.log(this.country.nativeElement.value="","val")
  ...
  constructor(private pageService: PageService, private importExcelService: ImportService,
    private countryServiceObj: CountryService, private stateService: StateService,
  ...
  ngOnInit() {
    this.commonService.setTitle('IMS-Location-State');
  ...
  public getSearchDataSelector() {
    ...
    this.countryServiceObj.getCountryList(countryData).subscribe(res => {
  ...
  public getStateList(data) {
    ...
    this.stateService.getStateList(data).subscribe(res => {
  ...
  createState(stateCode, stateName, countryId) {
    ...
    if (msg != "") {
      ...
      this.spinner.show();
      this.stateService.createState(this.dataForStateCreation).subscribe(response => {
  ...
  editState() {
    ...
    if (msg != "") {
      ...
      this.spinner.show();
      this.stateService.updateState(this.dataForStateCreation).subscribe(response => {
        this.spinner.hide();
        console.log("response received:-> " + response.model);
  ...
  changeStatus(id) {
    ...
    swal({
      ...
      if (result.value) {
        ...
        this.spinner.show();
        this.stateService.changeStatus(objToDel).subscribe(res => {
